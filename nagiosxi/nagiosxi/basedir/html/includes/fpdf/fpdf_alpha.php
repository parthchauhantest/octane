...
//require_once('fpdf_multicelltag/MultiCellTag/class.multicelltag.php');
//require_once('pdftable/lib/pdftable.inc.php');

class PDF_ImageAlpha extends FPDF{
//class PDF_ImageAlpha extends fpdf_multicelltag{
//class PDF_ImageAlpha extends PDFTable{
