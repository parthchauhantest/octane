...
//
// $Id: main.php 1724 2013-01-29 19:55:38Z mguthrie $
...
function show_page($error=false,$msg=""){
	...
	do_page_start(array("page_title"=>"Auth Check"),true);
?>
...
?>
	...
	<td>
	<select name="otype">
	<option value="<?php echo OBJECTTYPE_HOST;?>" <?php echo is_selected($otype,OBJECTTYPE_HOST);?>>Host</option>
	<option value="<?php echo OBJECTTYPE_SERVICE;?>" <?php echo is_selected($otype,OBJECTTYPE_SERVICE);?>>Service</option>
	<option value="<?php echo OBJECTTYPE_HOSTGROUP;?>" <?php echo is_selected($otype,OBJECTTYPE_HOSTGROUP);?>>Hostgroup</option>
	<option value="<?php echo OBJECTTYPE_SERVICEGROUP;?>" <?php echo is_selected($otype,OBJECTTYPE_SERVICEGROUP);?>>Servicegroup</option>
	</select>
	</td>
	</tr>
	<tr>
	<td>Object Name:</td>
	<td><input type="text" name="oname" value="<?php echo $oname;?>" size="15"> <input type="text" name="oname2" value="<?php echo $oname2;?>" size="15"></td>
	</tr>
	<tr>
	<td>
	</td>
